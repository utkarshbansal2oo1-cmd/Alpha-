// STRAY SCRATCH FILE -- not imported anywhere in the app. Created only to
// verify demoScenarios.js's logic from a plain Node script during
// development (Vite resolves extension-less imports; a raw `node`
// smoke-test does not, hence this .mjs copy with the extension added).
// Left in place because files in this workspace folder cannot be deleted;
// inert otherwise. See src/data/demoScenarios.js for the real module.
export {};
